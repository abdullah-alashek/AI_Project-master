...
const MessageTags = ({title,displyMessageTag}) => {
  return (
    <div className= {!displyMessageTag? 'aj-message-tags none': 'aj-message-tags'  }>
      <MessageTag title={title[0]} />
      <MessageTag title={title[1]} />
      <MessageTag title={title[2]} />
